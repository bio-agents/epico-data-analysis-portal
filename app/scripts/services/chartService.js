...
factory('ChartService',['$q','$sce','$window','portalConfig','ConstantsService','ColorPalette','d3','SimpleStatistics','T-Test',function($q,$sce,$window,portalConfig,ConstantsService,ColorPalette,d3,ss,tTest) {
					...
					case LIBRARY_HIGHCHARTS:
						...
						switch(gDataViewType) {
							case GRAPH_TYPE_BOXPLOT_HIGHCHARTS:
								...
								chart.options.options.agenttip = {
									animation: false,
	...
	function initializeSubtotalsCharts($scope) {
		...
		subtotals.options.options.agenttip.pointFormat = '<span style="color:{point.color}">\u25CF</span> {point.y}';
		...
		analysisSubtotals.options.options.agenttip.headerFormat = '';
		analysisSubtotals.options.options.agenttip.pointFormat = '{point.desc}<br /><span style="color:{point.color}">\u25CF</span> {point.y}';
