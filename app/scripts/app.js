...
//    'smart-table',
  ...
  .config(function ($locationProvider,$routeProvider,$uibAgenttipProvider) {
//  .config(function ($routeProvider,$uibAgenttipProvider,digestHudProvider) {
//	digestHudProvider.enable();
	...
	// This is to programmatically disable agenttips
	$uibAgenttipProvider.setTriggers({
		'never': 'mouseleave' // <- This ensures the agenttip will go away on mouseleave
	});
